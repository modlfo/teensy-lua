...
OPTIONS = -DLUA_32BITS -DLUA_CROSS_COMPILER -DF_CPU=96000000 -DUSB_SERIAL -DLAYOUT_US_ENGLISH -DUSING_MAKEFILE -DLAYOUT_US_ENGLISH
...
CPPFLAGS = -Wall -g -O3 -mcpu=cortex-m4 -mthumb -nostdlib -MMD $(OPTIONS) -I. -Iutility
...
# linker options
LDFLAGS = -O3 -Wl,--gc-sections,--defsym=__rtc_localtime=0 --specs=nano.specs -mcpu=cortex-m4 -mthumb -T$(MCU_LD)
